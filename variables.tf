...
variable "ec2_os" {
  description = "Intended Operating System/Distribution of Instance. Valid inputs are `amazon2`, `centos7`, `rhel7`, `rhel8`, `ubuntu18`, `ubuntu20`, `windows2012r2`, `windows2016`, `windows2019` `windows2022`"
  type        = string
}
